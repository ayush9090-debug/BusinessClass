        ...
        <div className="max-w-5xl mx-auto bg-white shadow-md rounded-2xl p-8">
          ...
          <section className="mb-8">
            <p className="text-gray-700 leading-relaxed">
              ...
              "our," or "us") values your right to privacy and is sincere about
              keeping your private information safe and secure. This Privacy
              Policy explains how we collect, use, store, and share your
              information when you visit our website, request a quote, make a
              reservation, or contact our customer service.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mt-3">
              However, no system can guarantee 100% security over the Internet.
            </p>
          </section>
